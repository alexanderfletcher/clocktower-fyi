...
export const CHARACTER_DATA = [
  ...
  },
  {
    ...
    team: "townsfolk",
    firstNightReminder:
      "Show the finger signal (0, 1, 2) for the number of evil alive neighbors.",
    otherNightReminder:
      "Show the finger signal (0, 1, 2) for the number of evil alive neighbors.",
    reminders: [],
    setup: false,
  ...
  },
  {
    ...
    firstNightReminder: "",
    otherNightReminder:
      "The previously protected player is no longer protected. The Monk points to a player not themself. Mark that player 'Safe'.",
    reminders: ["Safe"],
    setup: false,
    ability:
  ...
  },
  {
    ...
    team: "townsfolk",
    firstNightReminder:
      "Choose a character type. Point to a player whose character is of that type. Place the Balloonist's 'Know' reminder next to that player.",
    otherNightReminder:
      "Choose a player whose character type does not match the type from the previous night. Move the Balloonist's 'Know' reminder next to that player.",
    reminders: ["Know"],
    setup: true,
    ability:
  ...
  },
  {
    ...
    team: "townsfolk",
    firstNightReminder:
      "The cult leader might change alignment. If so, show them the thumbs up good signal or the thumbs down evil signal accordingly.",
    otherNightReminder:
      "The cult leader might change alignment. If so, show them the thumbs up good signal or the thumbs down evil signal accordingly.",
    reminders: [],
    setup: false,
  ...
  },
  {
    ...
    firstNightReminder: "",
    otherNightReminder:
      "Mark the recently killed executee with the 'Died Today' token. If they are good, the Cannibal will wake tonight when the executee would have woken. If they are evil, mark the Cannibal as 'Poisoned'. The Storyteller may pretend that the Cannibal has any ability.",
  ...
  },
  {
    ...
    otherNightReminder:
      "Wake all Minions together. Allow them to vote by pointing at who they want to babysit Lil' Monsta. The Storyteller may choose a player, that player dies.",
    reminders: [],
  ...
  },
  {
    ...
    firstNightReminder: "",
    otherNightReminder:
      "The Storyteller may choose a player, that player dies.",
